...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static byte[] getFileContent(String filePath) {
		String file = ConstProperties.getConfig("uploadPath")+filePath;
		try {
	 ...
	 * @throws Exception
	 */
	public static byte[] imageRequest(String imageUrl) throws Exception{
		//new一个URL对象
	 ...
	 * @param filePath 本地路径，比如D：XXX
	 * @return
	 */
	public static Boolean  imageRequest(String imageUrl,String filePath){
		File imageFile=null;
		FileOutputStream outStream=null;
		Boolean result=false;
		try {
			byte[] data = imageRequest(imageUrl);
	...
	/**
	 * 获取终端设备截图，保存到本地
	 * @param byData 图片的网络路径
	 * @param filePath 本地路径，比如D：XXX
	 * @return
	 */
	public static Boolean  imageRequest(byte[] byData,String filePath){
		File imageFile=null;
		FileOutputStream outStream=null;
		Boolean result=false;
		try {
	...
	public static Boolean  downFileRequest(String fileUrl,String filePath){
		File imageFile=null;
		FileOutputStream outStream=null;
		Boolean result=false;
		try {
			byte[] data = imageRequest(fileUrl);
			//new一个文件对象用来保存图片，默认保存当前工程根目录
			imageFile = new File(filePath);
			FileUtils.createFile(filePath);
			//创建输出流
