...
<div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <div style="padding-bottom: 10px;" id="sysRoleList_tool">
                <button
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${baseprefix}/js/system/sysRoleList.js?t=<%= System.currentTimeMillis()%>"></script>
</body>
</html>