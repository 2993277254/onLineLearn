...
<body ms-controller="tDiscussEdit">
<div class="layui-form" lay-filter="tDiscussEdit_form" id="tDiscussEdit_form" style="padding: 20px 30px 0 0;">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><span class="edit-verify-span">*</span>讨卵内容</label>
            <div class="layui-input-inline">
                <input type="input" name="content" maxlength="65,535" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item layui-hide">
            <button class="layui-btn" lay-submit lay-filter="tDiscussEdit_submit" id="tDiscussEdit_submit">提交</button>
        </div>
</div>
<script type="text/javascript" src="${baseprefix}/js/course/tDiscussEdit.js?t=<%= System.currentTimeMillis()%>"></script>
</body>
</html>